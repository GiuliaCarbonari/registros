...
def set_sleep_states(raw,path):
    ...
    states_anotations = mne.Annotations(onset,duration,description, orig_time=raw.annotations.orig_time) #le agregamos el origen_time del raw    raw2 = raw.copy().set_annotations(states_anotations)
